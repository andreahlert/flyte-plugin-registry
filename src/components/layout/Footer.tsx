        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-2">
            <div className="flex items-center gap-2.5 mb-4">
              <FlyteLogo className="w-6 h-6 text-[var(--accent)]" />
              <span className="font-semibold tracking-tight text-[var(--heading)]">
                Flyte Plugin Registry
              </span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li>
                <a href="https://docs.flyte.org" target="_blank" rel="noopener noreferrer" className="text-[var(--muted)] hover:text-[var(--accent)] transition-colors">
                  Documentation
                </a>
              </li>
              <li>
